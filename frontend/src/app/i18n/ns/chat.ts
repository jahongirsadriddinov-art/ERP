export const uz = {
  ...
  videoChatJoin: "Video chatga qo'shilish",
  videoChatActive: "🎥 Video chat faol — {{count}} kishi",
...
export const ru = {
  ...
  videoChatJoin: "Присоединиться к видеочату",
  videoChatActive: "🎥 Видеочат активен — {{count}} чел.",
